"""
Django settings for StreamingUI project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(DIRNAME, '..', 'gui/templates')],
        'OPTIONS': {
            'context_processors': [
...
ROOT_URLCONF = 'StreamingUI.urls'

WSGI_APPLICATION = 'StreamingUI.wsgi.application'
